...
```
이 저장소에 작성된 모든 내용은 위 저작물에서 언급하는 저작권법을 따릅니다.
따라서, 문제가 될 수 있는 소지가 있는 경우에 대해 알려주시면, 그 즉시 폐기하도록 하겠습니다.
```
...
#### chapter 2 데이터: 타입, 값, 변수, 이름 ([학습노트](./chapter_02.ipynb))
> 2.1 파이썬 데이터는 객체다
>
> 2.2 타입
>
...
#### chapter 3 숫자 ([학습노트](./chapter_03.ipynb))
